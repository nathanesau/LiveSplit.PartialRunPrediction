...
{
    public partial class PartialRunPredictionSettings : UserControl
    {
        private int _VisualCompareSplitNumber { get; set; }

        public int VisualCompareSplitNumber
        {
            get { return _VisualCompareSplitNumber; }
            set
            {
                _VisualCompareSplitNumber = value;
        ...
        public PartialRunPredictionSettings()
        {
            InitializeComponent();

            VisualCompareSplitNumber = 1;
        ...
        void PartialRunPredictionSettings_Load(object sender, EventArgs e)
        {
        ...
        public void SetSettings(XmlNode node)
        {
            ...
            VisualCompareSplitNumber = SettingsHelper.ParseInt(element["VisualCompareSplitNumber"]);
        ...
        private int CreateSettingsNode(XmlDocument document, XmlElement parent)
        {
            ...
            SettingsHelper.CreateSetting(document, parent, "VisualCompareSplitNumber", VisualCompareSplitNumber) ^
